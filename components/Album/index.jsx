      ...
      <div id="album" className="transition-item" onClick={this.state.showing ? this.hideMobileOverlay : null}>
				...
				<div id="cover" className={this.state.showing ? "covered" : null} onClick={this.showMobileOverlay}>
					<div id="overlay" className={this.state.showing ? "showing" : null}>
						<br/>
						<a target="_blank" href="https://open.spotify.com/album/0CdMLYwTEWKDFWUpNaewTP">Spotify</a>
						<a target="_blank" href="https://itunes.apple.com/us/album/model-home/id1266944102">iTunes</a>
						<a target="_blank" href="https://varsitystar.bandcamp.com/album/model-home">Bandcamp</a>
						<br/>
					</div>
					<img src={Cover} />
				</div>
